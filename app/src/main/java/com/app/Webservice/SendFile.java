 ...
 */
public class SendFile extends Request {
    ...
    public SendFile(int method, String url, Response.Listener resplistener, Response.ErrorListener errorListener, File file) {
    ...
    public SendFile(int method, String url, Response.Listener resplistener, Response.ErrorListener errorListener, MultipartEntity entity ) {
        super(method, url, errorListener);
        mListener = resplistener;
        this.entity = entity;
        mFilePart = null;
